...
export async function POST(request: NextRequest) {
  try {
    ...
    if (user.role !== "admin") {
      return NextResponse.json(
        {
          error: "Forbidden - Only admin can create geofences",
          code: "FORBIDDEN",
        },
        { status: 403 },
      );
...
export async function PUT(request: NextRequest) {
  try {
    ...
    if (user.role !== "admin") {
      return NextResponse.json(
        {
          error: "Forbidden - Only admin can update geofences",
          code: "FORBIDDEN",
        },
        { status: 403 },
      );
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    if (user.role !== "admin") {
      return NextResponse.json(
        {
          error: "Forbidden - Only admin can delete geofences",
          code: "FORBIDDEN",
        },
        { status: 403 },
      );
