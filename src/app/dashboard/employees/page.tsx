...
/* ─── Helpers ────────────────────────────────────────────── */
const COLORS = ["#4A154B", "#16A34A", "#7C3AED", "#2563EB", "#4A154B", "#DC2626"];
    ...
    <div className="relative">
      <select
        ...
        onFocus={(e) => {
          ...
          e.currentTarget.style.boxShadow = "0 0 0 3px rgba(74,21,75,0.12)";
        }}
        onBlur={(e) => {
  ...
  return (
    <DashboardLayout title="Employees" subtitle="Manage your organisation's people">
      ...
      >
          ...
          <div className="flex items-center gap-2.5">
            ...
            <motion.button
              ...
              style={{
                ...
                border: "none",
                cursor: "pointer",
                boxShadow: "0 4px 16px -4px rgba(74,21,75,0.25)",
              }}
            >
        ...
        >
          <StatCard label="Total Employees" value={employees.length} icon={RiGroupLine} accent="#4A154B" />
